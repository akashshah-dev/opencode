        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            const prepareRequest = () => {
              ...
              return { ...init, headers, body: SnowflakeTransform.transformRequestBody(init?.body) }
            }

            const transformResponse = (response: Response) => SnowflakeTransform.normalizeResponse(response)
