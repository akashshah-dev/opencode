...
export const Definitions = {
  ...
  "dialog.proxy.toggle": keybind("space", "Toggle proxy in proxy dialog"),
  "dialog.proxy.add": keybind("ctrl+a", "Add proxy in proxy dialog"),
  "dialog.proxy.edit": keybind("ctrl+e", "Edit proxy in proxy dialog"),
  "dialog.proxy.remove": keybind("ctrl+d", "Remove proxy in proxy dialog"),
